        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-8 col-md-12 form-regist">
            ...
            <div class="button-area">
                ...
                <p>Belum punya akun? <a href="itv_register.html">Daftar</a></p>
            </div>
         </div>
        </div>
      </div>
...
@section('isi')
    ...
    <div class="container mt-4">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-8 col-md-12 form-regist">
            <form method="POST" action="/it-venture/cek_akun">
                <h2 class="form-title">Login</h2>
                <input type="text" name="username" id="username" class="form-control form-slot transparent-input" placeholder="Username">
                <input type="password" name="pass" id="password" class="form-control form-slot transparent-input" placeholder="Password">
                <div class="button-area">
                    <input type="submit" class="form-button submit-button" value="SUBMIT">
                    <p>Belum punya akun? <a href="/it-venture/register">Daftar</a></p>
                </div>
            </form>
         </div>
        </div>
