...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../Aset/css/itv_home.css">
  ...
  <body class="bg">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top trn" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="#">
         <img src="../../Image/pingfest-transparent.png" class="d-inline-block align-top" alt="" loading="lazy"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Page/IT-Venture/itv_home.html">IT-Venture</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="Page/Seminar/seminar_home.html">Seminar</a>
            </li>
    ...
    <div class="container mt-4">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-8 col-md-12 form-regist">
            <form>
                <h2 class="form-title">Register</h2>
                <input type="text" id="username" class="form-control form-slot transparent-input" placeholder="Username">
                <input type="email" id="email" class="form-control form-slot transparent-input" placeholder="Email">
                <input type="password" id="password" class="form-control form-slot transparent-input" placeholder="Password">
            </form>
            <div class="button-area">
                <button class="form-button submit-button">SUBMIT</button>
                <p>Sudah punya akun? <a href="itv_login.html">Masuk</a></p>
            </div>
         </div>
        </div>
      </div>
...
@section('isi')
    ...
    <div class="container mt-4">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-8 col-md-12 form-regist">
            <form method="POST" action="/it-venture/simpan_akun">
                <h2 class="form-title">Register</h2>
                <input type="text" name="username" id="username" class="form-control form-slot transparent-input" placeholder="Username" value="{{ old('username') }}" required>
                <input type="email" name="email" id="email" class="form-control form-slot transparent-input" placeholder="Email" value="{{ old('email') }}" required>
                <input type="password" name="pass" id="password" class="form-control form-slot transparent-input" placeholder="Password" value="{{ old('pass') }}" required>
                <div class="button-area">
                    <input type="submit" class="form-button submit-button" value="SUBMIT">
                    <p>Sudah punya akun? <a href="/it-venture/login">Masuk</a></p>
                </div>
            </form>
         </div>
        </div>
