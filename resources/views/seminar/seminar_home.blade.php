...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../../Aset/css/seminar.css">
  ...
  <body class="bg">
    ...
    <div class="container top">
      <div class="row align-items-center">
        <div class="col-md-7 col-sm-12 sponsor-box">
          ...
          <a href="#"><button type="button" class="btn btn-lg btn-outline-light">Daftar</button></a>
        </div>

        <div class="col-md-5 col-sm-12 mt-4 mb-4">
          <img src="../../Image/Semnas.png" class="img-fluid" alt="Seminar">
        </div>
      </div>
    </div>

    <div class="container mt-4">
      <div class="col-md-12 col-sm-12 text-light text-center">
        <h1>Guest Star</h1>
      </div>
      <div class="row align-items-center sponsor-box">
        <div class="col-md-12 col-sm-12 mt-4 mb-4">
           <img src="https://i.ytimg.com/vi/SsRpv5yebVk/hqdefault.jpg" alt="">
        </div>
    ...
    <div class="container mt-4 mb-4">
      ...
      <div class="row justify-content-center align-items-center sponsor-box ">
        <div class="col-md-6 ">
          <img src="../../Image/Maskot_Upperright.png" class="img-fluid">
        </div>
      </div>
    </div>
  </div>
...
@section('isi')
    <div class="container top">
        ...
        <div class="col-md-7 col-sm-12 sponsor-box">
            <h1>Seminar Nasional</h1>
            <p>Seminar Nasional: LDR atau Learn Develops the Result adalah suatu seminar nasional yang ditujukan untuk kalangan muda terutama pelajar. Tema “Home Production” yang diusung mengajak para peserta seminar untuk dapat menghasilkan suatu karya apapun dengan ide mereka sendiri selama berada di rumah.</p>
            <a href="/seminar/register"><button type="button" class="btn btn-lg btn-outline-light">Daftar</button></a>
        </div>
